            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    ...
                    <div class="mb-5 sm:mb-8 text-center lg:text-left">
                        <h2 class="text-2xl font-extrabold text-gray-900 dark:text-white uppercase tracking-wide mb-2 lg:hidden">
                    ...
                    @if($errors->any())
                        <div class="mb-6 rounded-lg border-l-4 border-error-500 bg-error-50 p-4 dark:bg-error-500/10">
                            <p class="text-sm font-medium text-error-800 dark:text-error-500">{{ $errors->first() }}</p>
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus placeholder="admin@nikoteknik.com"
                            ...
                            <div>
                                ...
                                <div x-data="{ showPassword: false }" class="relative">
                                    ...
                                    <span @click="showPassword = !showPassword" class="absolute top-1/2 right-4 z-30 -translate-y-1/2 cursor-pointer text-gray-500 dark:text-gray-400">
                                        ...
                                        <svg x-show="showPassword" class="fill-current" style="display:none;" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-sm flex-col items-center">
                        <h2 class="text-4xl font-extrabold text-white uppercase tracking-wide mb-4 text-center">
                            NIKO <span class="text-brand-500">TEKNIK</span> AC
                        </h2>
                        <p class="text-center text-gray-300 dark:text-white/60">
                            Sistem Informasi Manajemen Data Barang, Penjualan AC, dan Riwayat Servis. Terpusat dan Terintegrasi.
                        </p>
                    </div>
                </div>
            </div>
