...
@section('content')
<x-common.page-breadcrumb pageTitle="Tambah Master Pelanggan" />

<div class="space-y-6">
    <form action="{{ route('customers.store') }}" method="POST">
        @csrf
        
        <x-common.component-card title="Formulir Data Pelanggan">
            <div class="p-5 sm:p-6 grid grid-cols-1 gap-6 xl:grid-cols-2">
                ...
                <div class="xl:col-span-2">
                    ...
                    <textarea name="alamat" rows="4" placeholder="Masukkan detail alamat (Jalan, RT/RW, Desa, Kecamatan)"
